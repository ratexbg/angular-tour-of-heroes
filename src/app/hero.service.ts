...
export class HeroService {
  ...
  constructor(private http: HttpClient, private messageService: MessageService) { }  // konstruktora deklarira private messageService or tip MessageService; tipichno service-in-service, msgservice in heroservcie in herocompoent.

  // getHeroes(): Hero[] {    // metod getHeroes ; tip Hero[]; pravi array s mock-dannite kato informaciq v nego
  //   return HEROES;
  // }
